...
import { GAME_TEXT_STYLE } from '../consts/CText';
import { CustomTextStyle } from './GameTextStyle';

export class BaseElement extends Container {
    ...
    protected getFont():TextStyle {
        ...
        textStyle.updateStyle(GAME_TEXT_STYLE);
        return textStyle;
    }
